...
function App() {
  ...
  useEffect(function () {
    fetch("http://localhost:8000/questions")
      ...
      .catch((err) =>  dispatch({ type: "dataReceived", payload: dummyData.questions })) //modify this Code Because Of Fetching Initial data in live otherwise npm run server need run alltime
